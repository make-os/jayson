...
export type RequestParamsLike = Array<any> | object | string | undefined;
...
type JSONRPCCallbackTypeBatch =
	| JSONRPCCallbackTypeBatchPlain
...
export type ServerRouterFunction = (
	this: Server,
	method: string,
	params: RequestParamsLike,
) => MethodLike;
...
export declare class Server extends events.EventEmitter {
	...
	call(
		...
		originalCallback?: JSONRPCCallbackType,
	): void;
	call(
		request: JSONRPCRequestLike | Array<JSONRPCRequestLike>,
		context: object,
...
export declare class Client extends events.EventEmitter {
	...
	request(
		method: Array<JSONRPCRequestLike>,
		callback: JSONRPCCallbackTypeBatch,
